      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-12 space-y-4 pt-16">
            <div className="relative h-10 w-48 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded overflow-hidden mx-auto">
            ...
            <div className="relative h-6 w-80 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded overflow-hidden mx-auto">
              <div className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-white to-transparent"></div>
            </div>
          </div>
